#
#Figures 4 and 9 of the paper can be reproduced using this script
#
...
#
#values of PDFs(nhist, time). The size of each (Max(area)-Min(area))/nhist
#
...
#cloud_stat_phalfD10(time,2) contains the mean areaa of rain cores as a function of time for the 10th diurnal cycle 
#cloud_stat_phalfD10(time,2) contains the mean areaa of rain cores as a function of time for the 10th diurnal cycle
...
#
#These fields (e.g., cloud_stat_mhalfD10) contain the mean statistiques of rainfall events as a function of time
#cloud_stat_mhalfD10(time,11) contains the mean radius of rain cores as a function of time for day 10 
#cloud_stat_mhalfD10(time,2) contains the mean areaa of rain cores as a function of time for the 10th diurnal cycle 
#cloud_stat_mhalfD10(time,2) contains the mean areaa of rain cores as a function of time for the 10th diurnal cycle
#cloud_stat_mhalfD10(time,1) contains the number of rain cores as a function of time for the 10th diurnal cycle
#cloud_stat_mhalfD10(time,3) contains the standard deviation of rain cores radii as a function of time for the 10th diurnal cycle
#
...
#control simulations
#
#These fields (e.g., cloud_stat_ctrlD10) contain the mean statistiques of rainfall events as a function of time
#cloud_stat_ctrlD10(time,11) contains the mean radius of rain cores as a function of time for day 10 
#cloud_stat_ctrlD10(time,2) contains the mean areaa of rain cores as a function of time for the 10th diurnal cycle 
#cloud_stat_ctrlD10(time,2) contains the mean areaa of rain cores as a function of time for the 10th diurnal cycle
#cloud_stat_ctrlD10(time,1) contains the number of rain cores as a function of time for the 10th diurnal cycle
#cloud_stat_ctrlD10(time,3) contains the standard deviation of rain cores radii as a function of time for the 10th diurnal cycle
#
...
#
#simulations following homogenization
#
#These fields (e.g., cloud_stat_rthqvD10) contain the mean statistiques of rainfall events as a function of time
#cloud_stat_rthqvD10(time,11) contains the mean radius of rain cores as a function of time for day 10 
#cloud_stat_rthqvD10(time,2) contains the mean areaa of rain cores as a function of time for the 10th diurnal cycle 
#cloud_stat_rthqvD10(time,2) contains the mean areaa of rain cores as a function of time for the 10th diurnal cycle
#cloud_stat_rthqvD10(time,1) contains the number of rain cores as a function of time for the 10th diurnal cycle
#cloud_stat_rthqvD10(time,3) contains the standard deviation of rain cores radii as a function of time for the 10th diurnal cycle
#
